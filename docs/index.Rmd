...
Supplementary code for the two-dimensional derivative information emulators, of the SIRS disease model, constructed in Chapter 4. The code here is an extension of that in the <a href="https://www.maths.dur.ac.uk/users/i.r.vernon/UQIV/_site/index.html" >Uncertainty Quantification IV Computer Practicals</a>.
